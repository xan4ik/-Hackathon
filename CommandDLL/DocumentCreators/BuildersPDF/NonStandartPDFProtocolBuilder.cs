...
{
    public class NonStandartPDFProtocolBuilder : StandartPDFMonitorBuilder, IDocumentBuilder<NonStandartDocumentDTO>
    {
        public void SetContent(NonStandartDocumentDTO content)
        {
            ...
            base.TryReplaceSring("_left_", content.LeftHeterogeneity.ToString("0.00"));
            base.TryReplaceSring("_right_", content.RightHeterogeneity.ToString("0.00"));
